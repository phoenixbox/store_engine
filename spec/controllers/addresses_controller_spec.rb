  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved address as @address" do
        ...
        post :create, {:address => { "full_name" => "invalid value" }}, valid_session
        assigns(:address).should be_a_new(Address)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested address" do
        ...
        Address.any_instance.should_receive(:update_attributes).with({ "full_name" => "MyString" })
        put :update, {:id => address.to_param, :address => { "full_name" => "MyString" }}, valid_session
      end
