...
describe Product do 
  context "viewing products" do
    ...
    it "link to detail page displays details" do
      Product.create(title: "Nalgene Water Bottle", description:"a really strong water bottle", price:"12345", categories_list:"bottle", visible: true)
    ...
    it "should not be visible when product is retired" do
      Product.create(title: "Nalgene Water Bottle", description:"a really strong water bottle", price:"12345", categories_list:"bottle", visible: false)
      visit root_path
